namespace FireworksDX.Config
{
    public static class FireworksConfig
    {
        ...
        /// <summary>
        /// Percorso personalizzato per il file audio di esplosione.
        /// Se null o vuoto, usa il path di default (Audio\explosion.wav) relativo alla DLL.
        /// </summary>
        ...
        // ---------------------------------------------------------
        // PROFILO 4 — MEGA SHOW (massima intensità)
        // ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // PROFILO 5 — GOLDEN RAIN (oro elegante)
        // ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // PROFILO 6 — CYBER NEON (futuristico)
        // ---------------------------------------------------------
        public static void LoadCyberNeon()
        {
            ...
            EnableGlow = true;
            EnableTwinkle = true;
            EnableSmoke = false; // neon = pulito
        }

        // ---------------------------------------------------------
        // PROFILO 7 — CALM FESTIVAL (rilassato)
        // ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // PROFILO 8 — RED DRAGON (aggressivo)
        // ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // PROFILO 9 — WinterFestival 
		// Effetto “ghiaccio”, scie fredde, esplosioni lente e luminose
        // ---------------------------------------------------------		
        ...
        // ---------------------------------------------------------
        // PROFILO 10 — HalloweenSpirits
		// Colori arancioni/viola, esplosioni irregolari, fumo denso.
        // ---------------------------------------------------------		
        ...
        // ---------------------------------------------------------
        // PROFILO 11 — SummerBeachParty
		// Colori vivaci, esplosioni ampie, scie corte e pulite.
		// ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // PROFILO 12 — ChristmasMagic
		// Colori rosso/verde/oro, scie lunghe, esplosioni morbide.
		// ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // PROFILO 13 — Chrysanthemum
		// Esplosione sferica perfetta, scie lunghe, decadimento uniforme.
		// ---------------------------------------------------------		
        ...
        // ---------------------------------------------------------
        // PROFILO 14 — Peony
		// Esplosione rotonda senza scie lunghe, molto comune negli spettacoli reali.
		// ---------------------------------------------------------			
        ...
        // ---------------------------------------------------------
        // PROFILO 15 — Willow
		// Scie lunghissime che “cadono” lentamente come un salice piangente.
		// --------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // PROFILO 16 — PalmTree
		// Esplosione con “tronco” centrale e rami laterali.
		// --------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // PROFILO 17 — StrobeShell
		// Esplosioni con scintillio intermittente molto forte.
		// -------------------------------------------------------- 
